...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["She Calls Me Daddy Too",		"Beat Week 1 on Hard with no Misses.\nI am the real rap king",				'week1_nomiss',			false],
		["No More Tricks",				"Beat Week 2 on Hard with no Misses.\nNot really scary at all",				'week2_nomiss',			false],
		["Call Me The Hitman",			"Beat Week 3 on Hard with no Misses.\nGo Pico, yeah yeah go Pico yeah.",				'week3_nomiss',			false],
		["Lady Killer",					"Beat Week 4 on Hard with no Misses.\nDo I have to see them die?",				'week4_nomiss',			false],
		["Missless Christmas",			"Beat Week 5 on Hard with no Misses.\nMerry... oh.",				'week5_nomiss',			false],
		["Highscore!!",					"Beat Week 6 on Hard with no Misses.\nMy score was 69420.",				'week6_nomiss',			false],
		["You'll Pay For That...",		"Beat Week 7 on Hard with no Misses.\nA achievement you can\'t normally unlock.",				'week7_nomiss',			 true],
		["What a Funkin' Disaster!",	"Complete a Song with a rating lower than 20%.\nSkill Issue smh.",	'ur_bad',				false],
		["Perfectionist",				"Complete a Song with a rating of 100%.\nHonestly, you rock!",			'ur_good',				false],
		["Roadkill Enthusiast",			"Watch the Henchmen die over 100 times.\nYeah I know :(",			'roadkill_enthusiast',	false],
		["Oversinging Much...?",		"Hold down a note for 10 seconds.\nAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",					'oversinging',			false],
		["Hyperactive",					"Finish a Song without going Idle.\nBeep!",				'hype',					false],
		["Just the Two of Us",			"Finish a Song pressing only two keys.\nJust use One Arrow chart type",			'two_keys',				false],
		["Toaster Gamer",				"Have you tried to run the game on a toaster?\nWhy play at 60 fps anyway?",		'toastie',				false],
		["Debugger",					"Beat the \"Test\" Stage from the Chart Editor or Freeplay",	'debugger',				 true],
		["Ideas?",						"please?",	'ass',				 true]
	];
